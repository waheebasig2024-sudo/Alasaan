    ...
    <View style={[styles.container, { paddingTop: Platform.OS === "web" ? 0 : insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerSide}>
          ...
          <TouchableOpacity style={styles.headerIconBtn} onPress={() => router.push("/groq-chat" as any)} activeOpacity={0.7} accessibilityLabel="دردشة سريعة مع إنترنت">
            <Feather name="zap" size={20} color={COLORS.textSecondary} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.headerIconBtn} onPress={() => router.push("/offline-ai")} activeOpacity={0.7} accessibilityLabel="Aiden بدون نت">
            <Feather name="cpu" size={20} color={COLORS.textSecondary} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.headerIconBtn} onPress={() => router.push("/security" as any)} activeOpacity={0.7} accessibilityLabel="Security Dashboard">
